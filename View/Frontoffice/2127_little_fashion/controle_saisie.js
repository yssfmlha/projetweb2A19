...
function Est_Nom()
{
    const varia=document.getElementById("LastName").value;
...
function Est_Prenom()
{
    const varia2=document.getElementById("FirstName").value;
...
function Est_mail()
{
    const varia4=document.getElementById("gmail").value;
...
{
    const varia3=document.getElementById("number").value;
