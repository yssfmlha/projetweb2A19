...
function EST_id_startup()
{
    const varia0=document.getElementById("id_startup").value;
    let spam0=document.getElementById("0");
    const num= /^\d+$/;
    if(num.test(varia0)==true)
    {
    ...
    {
        spam3.innerHTML="Veuillez entrer un id valide";
