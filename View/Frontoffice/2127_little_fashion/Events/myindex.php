...
-->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div class="d-none d-lg-block">
                            <a href="home.php" class="bi-person custom-icon me-3"></a>
    ...
    <div class="main-banner">
        <div class="counter-content" style="margin-top: 80px;">
            <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-content">
                        <div class="next-show" style="margin-top: 350px;" >
            ...
            <?php $counter= 0 ;foreach($tab1 as $Event ){
                ...
                <div class="col-lg-4" >
                    <div class="event-item">
                        <div class="thumb">
                           <img src="../../assets/images/event-0<?php echo $counter + 1 ;?>.jpg" || alt="">
                        </div>
                        <div class="down-content">
                            <h4><?php echo $Event["Nom_Event"];?></h4>
                            <ul>
