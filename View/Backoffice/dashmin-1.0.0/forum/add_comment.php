...
$info=$userc->listuser($_SESSION["user_id"]);
    try {
        ...
        if ($postId && $author && $commentText) {
            $stmt = $conn->prepare("INSERT INTO comments (post_id, author, comment_text,author_id) VALUES (:post_id, :author, :comment_text,:author_id)");
            ...
            // Redirect back to the post or comments section after adding comment
            header("Location: tables.php?post_id={$postId}");
            exit();
        } else {
...
<form method="POST" action="add_comment.php">
    ...
    <textarea name="comment_text" placeholder="Comment" oninput="censorInput(this)" required></textarea><br>
    <button type="submit">Add Comment</button>
    <a href="tables.php">Cancel</a>
</form>
