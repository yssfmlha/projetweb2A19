...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($author) || empty($title) || empty($content)) {
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO posts (author, title, content) VALUES (:author, :title, :content)");
...
<form method="POST" action="add_post.php">
    <input type="text" name="author" placeholder="Author" oninput="censorInput(this)" required><br>
