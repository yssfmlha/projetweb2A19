<?php
require '../../../Controller/projetsC.php';
require '../../../Model/projets.php';
$projets1=new projetsC();
...
&&!empty($_POST["Date_Fin"])&&!empty($_POST["Statut_Projet"]) )
{
    ...
    $projets1->updateprojets($projet,$_GET['idd']);
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Ahmed Aziz Ammar</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="adminprojets.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Projets</a>
                    <a href="admin_startup.php" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Nos Startups</a>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Sadek send you a message</h6>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Youssef send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Aymen send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Ahmed Aziz Ammar</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="gab">
<form  method="POST" onsubmit="return GAB();" >
    <div class="row">
    <div class="input-groupe">
                <select name="id_startup" id="id_startup">
                <?php
        ...
        <div class="input-groupe">
            <input type="text"  id="Nom_projet" name="Nom_projet" value="<?php echo $_GET["nom"];?>">
            <span id="1"></span>
    ...
    <div class="input-groupe">
            <textarea type="text"  id="Description_projet" name="Description_Projet"><?php echo $_GET["desc"];?></textarea>
            <span id="2"></span>
    ...
    <div class="row">
        <div class="input-groupe">
            <input type="date"  id="Date_Debut" name="Date_Debut" value="<?php echo $_GET["dated"];?>">
            <span id="3"></span>
            <label for="Date_Debut">Date debut du projet</label>
            
        </div>
        <div class="input-groupe">
            <input type="date"  id="Date_Fin" name="Date_Fin" value="<?php echo $_GET["datef"];?>">
            <span id="4"></span>
    ...
    <div class="input-groupe">
            <input type="text"  id="Statut_Projet" name="Statut_Projet" value="<?php echo $_GET["stat"];?>">
            <span id="5"></span>
