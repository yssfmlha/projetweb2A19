...
if (
    ...
    if (
        ...
        $newname = $_POST['newnom']; 
        $DonC->updateDonUsernom($newname,$oldid);
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Table Start -->
            <form action="" method="POST" onsubmit="return namecontrol()">
            <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="newnom" placeholder="jhondoe" value="<?php echo($_GET['oldnom'])?>" id="name">
                            <p style="position: relative;left: 260px; top: -68px;height: 0px;" id="namecontrol"></p>
                            <label for="floatingText">New Name:</label>
                        </div>
