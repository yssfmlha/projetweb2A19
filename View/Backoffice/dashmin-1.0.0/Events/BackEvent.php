            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Events/Particip</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="BackEvent.php" class="dropdown-item active">Events</a>
                            <a href="BackParticipant.php" class="dropdown-item">Participation</a>
                        </div>
                    </div>
                    <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
                    <a href="form.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Forms</a>
                    <a href="" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>OO</a>
                    <a href="" class="nav-item nav-link"><i class="fa fa-table me-2"></i>OO</a>
                    <div class="nav-item dropdown">
                ...
                <div class="row g-4" >
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Top 5 Sales Events</h6>
...
<?php
$tab = $c->listEvents();
$topSalesEvents = $p->getTopSalesEvents();
$eventLabels = [];
$eventSalesData = [];

foreach ($topSalesEvents as $event) {
    foreach($tab as $evt){
        if($evt['Mat_Event'] == $event['id_EventPar'])
            $eventLabels[] = explode(' ', $evt['Nom_Event'])[0];
    }
    $eventSalesData[] = $event['totalTickets'];
}
?>
<script>
    ...
    var myChart4 = new Chart(ctx4, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode($eventSalesData); ?>
            }]
        },
        options: {
            responsive: true
