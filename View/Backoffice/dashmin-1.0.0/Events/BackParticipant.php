                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="BackEvent.php" class="dropdown-item">Evenements</a>
                            <a href="BackParticipant.php" class="dropdown-item active">Participation</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><center><img src="<?php echo ("../../../Frontoffice/2127_little_fashion/Events/".$Participant["QrCode_Participant"]);?>" width="80" height="80"></center></td>
                                        <td><center><a class="btn btn-sm btn-primary" href = "DelParticipant.php?Matricule=<?php echo $Participant["id_Participant"];?>&idevent=<?php echo $Participant["id_EventPar"];?>">Supprimer</a></center></td>
                                    </tr>
                                <?php
                                }?>
                            </tbody>
