                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-4">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" aria-label="With textarea" id="About" name="About"></textarea>
                            </div>
                        ...
                        <div class="form-floating mb-3">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" id="Prix"  name="Prix">
