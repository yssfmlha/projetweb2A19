            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="../forum/tables.php" class="nav-item nav-link"><i class="fa fa-underline me-2"></i>Forum</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="../produit/listproduit.php" class="dropdown-item active">Products</a>
...
<body>
    ...
    <form method="POST" onsubmit="return validerprod();">
        <table>
            ...
            <tr>
                <td><label for="categorie_ref">reference categorie :</label></td>
                <td>
                    <input type="text" id="categorie_ref" name="categorie_ref" />
                    <span id="erreurEmail" style="color: red"></span>
                </td>
            </tr>
