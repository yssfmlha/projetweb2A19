                ...
                <a href="../forum/tables.php" class="nav-item nav-link"><i class="fa fa-underline me-2"></i>Forum</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="../produit/listcategorie.php" class="dropdown-item active">Categories</a>
                        </div>
                    </div>
...
<body>
    ...
    <div id="error">
        ...
        <form action="" method="POST">
            <table>
            <div class="mb-3 row">
    <label for="Id_categorie" class="col-sm-2 col-form-label">Id categorie :</label>
    <div class="col-sm-2">
        <input type="text" class="form-control" id="Id_categorie" name="Id_categorie" value="<?php echo $CTG['Id_categorie'] ?>" readonly />
        <span id="erreurNom" style="color: red"></span>
    </div>
</div>
<div class="mb-3 row">
    <label for="nom_categorie" class="col-sm-2 col-form-label">Nom :</label>
    <div class="col-sm-2">
        <input type="text" class="form-control" id="nom_categorie" name="nom_categorie" value="<?php echo $CTG['nom_categorie'] ?>" />
        <span id="erreurNom" style="color: red"></span>
    </div>
</div>
<div class="mb-3 row">
