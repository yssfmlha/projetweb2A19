<?php
    ...
    if(isset($_POST["name"])&&isset($_POST["founder"])&&isset($_POST["email"])&&isset($_POST["number"])&&isset($_POST["desc"])){
        if(!empty($_POST["name"])&&!empty($_POST["founder"])&&!empty($_POST["email"])&&!empty($_POST["number"])&&!empty($_POST["desc"])){
            $Charite=new Charite($_POST["name"],$_POST["desc"],$_POST["founder"],$_POST["email"],$_POST["number"]);
            $ChariteC->updateCharite($Charite,$_GET["id"]);
                    ...
                    <div class="col-sm-12 col-xl-6">
                        ...
                        <form method="POST" onsubmit="return control()">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="name" placeholder="" name="name" onkeyup="charitynamecontrol()" value="<?php echo($_GET["nom"])?>">
                                <p style="position: relative;left: 490px; top: -50px;height: 0px;" id="namecontrol"></p>
                                <label for="floatingInput">Charity Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="founder" placeholder="Password" name="founder" onkeyup="foundercontrol()" value="<?php echo($_GET["fondateur"])?>">
                                <p style="position: relative;left: 490px; top: -60px;height: 0px;" id="foundercontrol"></p>
                                <label for="floatingPassword">Founder</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="email" placeholder="Password" name="email" onkeyup="emailcontrol()" value="<?php echo($_GET["email"])?>">
                                <p style="position: relative;left: 490px; top: -45px;height: 0px;" id="emailcontrol"></p>
                                <label for="floatingPassword">Email</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="number" placeholder="Password" name="number" onkeyup="numbercontrol()" value="<?php echo($_GET["tel"])?>">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="desc" style="height: 150px;" name="desc" onkeyup="desccontrol()"><?php echo($_GET["desc"])?></textarea>
