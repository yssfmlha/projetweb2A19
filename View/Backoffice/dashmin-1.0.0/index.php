...
<body>
    <?php
        foreach($var as $d){
            echo("<input type='hidden' value='".$d["d"]."' id='total'>");
        }
        foreach($tab as $data){
            echo("<input type='hidden' name='dataname' value='".$data["nom_charite"]."'>");
            echo("<input type='hidden' name='data' value='".$data["don"]."'>");
        }
        echo("<!-- seperator -->");
        foreach($list as $amount){
            echo("<input type='hidden' name='amountname' value='".$amount["chart"]."'>");
            echo("<input type='hidden' name='amount' value='".$amount["sum"]."'>");
        }
    ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Donations to Charities</h6>
                            </div>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Money per Charity</h6>
                            </div>
