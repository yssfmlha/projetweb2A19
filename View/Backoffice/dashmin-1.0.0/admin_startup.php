...
<body>
    ...
    {?>
        <tr>
            ...
            <td><a href = "updatestartup.php?idd=<?php echo $startup["id_startup"];?>&nom=<?php echo $startup["Nom"];?>&dom=<?php echo $startup["domaine"];?>&nomf=<?php echo $startup["nom_f"];?>&prenom=<?php echo $startup["prenom"];?>&de=<?php echo $startup["de"];?>&email=<?php echo $startup["email"];?>&tel=<?php echo $startup["telephone"];?>">Update</a></td>
        </tr>
    <?php
    }?>
                                    </tbody>
