...
$nomsProjetsParStartup = $projets->afficherNomsProjetsParStartup();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Startup</a>
                        <div class="dropdown-menu bg-transparent border-0">
                        <a href="admin_startup.php" class="dropdown-item ">Nos Startups</a>
                            <a href="adminprojets.php" class="dropdown-item active">Projets</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <form class="d-none d-md-flex ms-4" method="POST" action="research2.php">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Les projets de startups</h6>
    ...
    {?>
        <tr>
            ...
            <td><a href = "deleteprojets.php?idd=<?php echo $projets["id_projet"];?>">Delete</a></td>
            <td><a href = "updateprojets.php?idd=<?php echo $projets["id_projet"];?>&nom=<?php echo($projets["Nom_projet"]);?>&desc=<?php echo($projets["Description_Projet"]);?>&dated=<?php echo($projets["Date_Debut"]);?>&datef=<?php echo($projets["Date_Fin"]);?>&stat=<?php echo($projets["Statut_Projet"]);?>">Update</a></td>
        </tr>
    <?php
      }?>
                                    </tbody>
                            ...
                            <tbody>
                                <?php
                                foreach ($nomsProjetsParStartup as $row) {
                                    echo "<tr>";
                                    echo "<td>{$row['Nom_startup']}</td>";
