<?php
require '../../controle/projetsC.php';
require '../../modele/projets.php';
...
<form  method="POST" onsubmit="return GAB();" >
    ...
    <div class="input-groupe">
            <input type="text"  id="id_startup" name="id_startup">
    ...
    <div class="input-groupe">
            <textarea type="text"  id="Description_projet" name="Description_Projet"></textarea>
            <span id="2"></span>
    ...
    <div class="input-groupe">
            <input type="text"  id="Statut_Projet" name="Statut_Projet">
            <span id="5"></span>
