...
<html lang="en">
    <head>
        ...
        <title>Ineed - Contact Page</title>
...
-->
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="contact.html">Blog</a>
                            </li>
                        </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 header-info">
                            <h1>
                                <span class="d-block text-primary">Share your thoughts</span>
                                <span class="d-block text-dark">And experrience</span>
                            </h1>
                        </div>
                    </div>
                </div>

                <img src="images/header/positive-european-woman-has-break-after-work.jpg" class="header-image img-fluid" style="padding-left: 20px;" alt="">
            </header>
        ...
        <table>
            ...
            <tr>
                <td><button type="submit" id="submitPost">Add Post</button></td>
                <td><button type="reset" value="Cancel">cancel</button></td>
            </tr>
        </table>
