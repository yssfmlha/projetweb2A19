            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="Dated" name="Date" placeholder="Date debut d'Evenement">
                            <label for="floatingPassword">Date debut d'Evenement</label>
                            <h6 id="validationMessage2" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="Date" name="Datef" placeholder="Date fin Evenement">
