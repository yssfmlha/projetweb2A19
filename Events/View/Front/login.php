            ...
            <div class="row">
                <div class="col-lg-10 col-12 header-info">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <p>Don't have an account? <a href="register.php">Register Now</a> <br><a href="new.php">forget password</a</p> 

                        <div class="g-recaptcha" data-sitekey="6LfdeSQpAAAAAON_U780InOW2Q16Vei6c9KRrbIU"></div>
                        <br/>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-8">
                ...
                <ul class="footer-menu d-flex flex-wrap">
                    ...
                    <li class="footer-menu-item"><a class="nav-link" href="myindex.php">Events</a></li>
                </ul>
            </div>
...
<script>
      function onsubmit() {
        grecaptcha.ready(function() {
          grecaptcha.execute('6LfdeSQpAAAAAON_U780InOW2Q16Vei6c9KRrbIU', { action: 'submit' }).then(function(token) {
