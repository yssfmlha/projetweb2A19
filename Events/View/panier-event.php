  ...
  <head>
    ...
    <div class="tickets-page contented activate" id="content-1">
        <div class="container">
            ...
            <?php $i=0 ; $tab = $c1->listParticipants(); foreach($tab as $Participant ){ if( $i < 6 ) { $Event = $c->CherEvent_Mat($Participant['id_EventPar']); foreach($Event as $evt) {$nomEv = $evt['Nom_Event']; $adrEvt = $evt['Adresse_Event']; $ddEvt = $evt['Date_Event']; $dfEvt = $evt['DateF_Event'];}?>
                <div class="col-lg-4">
    ...
    <div class="tickets-page contented" id="content-2">
        <div class="container">
            ...
            <?php $i=0 ; $tab = $c1->listParticipants(); foreach($tab as $Participant ){ if( $i < 12 && $i > 5  ) { $Event = $c->CherEvent_Mat($Participant['id_EventPar']); foreach($Event as $evt) {$nomEv = $evt['Nom_Event']; $adrEvt = $evt['Adresse_Event']; $ddEvt = $evt['Date_Event']; $dfEvt = $evt['DateF_Event'];}?>
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            <img src="<?php echo $Participant["QrCode_Participant"];?>">
    ...
    <div class="tickets-page contented" id="content-3">
        <div class="container">
            ...
            <?php $i=0 ; $tab = $c1->listParticipants(); foreach($tab as $Participant ){ if(  $i > 11 && isset($Participant) ) {$Event = $c->CherEvent_Mat($Participant['id_EventPar']); foreach($Event as $evt) {$nomEv = $evt['Nom_Event']; $adrEvt = $evt['Adresse_Event']; $ddEvt = $evt['Date_Event']; $dfEvt = $evt['DateF_Event'];}?>
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            <img src="<?php echo $Participant["QrCode_Participant"];?>">
