                ...
                <form method="POST" onsubmit="ValiderAdd();">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Matricule"  name="Mat" placeholder="Matricule Evenement">
                            <label for="floatingInput">Matricule Evenement</label>
                            <h6 id="resultatMessage" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="Nom" name="Nom" placeholder="Nom Evenement">
                            <label for="floatingPassword">Nom Evenement</label>
                            <td><h6 id="validationMessage" style="color : red ; font-size: 12px;"></h6></td>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Adresse"  name="Adresse" placeholder="Adresse Evenement">
                            <label for="floatingInput">Adresse Evenement</label>
                            <h6 id="validationMessage1" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="date" class="form-control" id="Dated" name="Date" placeholder="Date debut d'Evenement">
                            <label for="floatingPassword">Date debut d'Evenement</label>
                            <h6 id="validationMessage2" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="date" class="form-control" id="Datef" name="Datef" placeholder="Date fin Evenement">
                            <label for="floatingPassword">Date fin Evenement</label>
                            <h6 id="validationMessage3" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="About" name="About" placeholder="D'apres Evenement">
                            <label for="floatingPassword">D'apres Evenement</label>
                            <h6 id="validationMessage4" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Prix"  name="Prix" placeholder="Prix Ticket d'Evenement">
                            <label for="floatingInput">Prix Ticket d'Evenement</label>
                            <h6 id="validationMessage5" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="NBTKT" name="NBTKT" placeholder="NBTKT">
                        ...
                        <input type="reset" value="Annuler" class="btn btn-primary py-3 w-100 mb-4" > 
                    </div>
                </form>
            <!-- Chart End -->
