            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="Dated" name="Date" placeholder="Date debut d'Evenement" value="<?php echo $Evenement['Date_Event']; ?>">
                            <label for="floatingPassword">Date debut d'Evenement</label>
                            <h6 id="validationMessage2" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Datef"  name="Datef" placeholder="Date fin d'Evenement" value="<?php echo $Evenement['DateF_Event']; ?>">
                            <label for="floatingInput">Date fin d'Evenement</label>
                            <h6 id="validationMessage3" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="About" name="About" placeholder="D'apres Evenement" value="<?php echo $Evenement['About_Event']; ?>">
                            <label for="floatingPassword">D'apres Evenement</label>
                            <h6 id="validationMessage4" style="color : red ; font-size: 12px;"></h6>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Prix"  name="Prix" placeholder="Prix Ticket d'Evenement" value="<?php echo $Evenement['Price_Event']; ?>">
