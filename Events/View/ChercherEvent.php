            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <a class="btn btn-primary" href = "BackEvent.php" style="margin: 10px;">Revenir</a>
                        <table class="table text-start align-middle table-bordered table-hover mb-0" id="myTable">
                        <thead>
                                <tr>
                                    <th class="Clicked" scope="col" class="no-sort">Matricule</th>
                                    <th class="not_Clicked" scope="col">Nom</th>
                                    <th class="not_Clicked" scope="col">Lieu</th>
                                    <th class="Clicked" scope="col" class="no-sort">Date</th>
                                    <th class="Clicked" scope="col" class="no-sort">Date fin</th>
                                    <th class="not_Clicked" scope="col">Description</th>
                                    <th class="Clicked" scope="col" class="no-sort">Attendance</th>
                                    <th class="Clicked" scope="col" class="no-sort">Prix</th>
                                    <th class="not_Clicked">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href = "UPdateEvent.php?Matricule=<?php echo $Event["Mat_Event"];?>">Modifier</a> 
                                        <a class="btn btn-sm btn-primary" href = "DelEvent.php?Matricule=<?php echo $Event["Mat_Event"];?>">Supprimer</a></td>
                                    </tr>
                                <?php
                                }?>
                            </tbody>
