            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <a class="btn btn-primary" href = "BackParticipant.php" style="margin: 10px;">Revenir</a>
                            ...
                            <tbody>
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href = "DelParticipant.php?Matricule=<?php echo $Participant["id_Participant"];?>">Supprimer</a></td>
                                    </tr>
                                <?php
                                }?>
                            </tbody>
